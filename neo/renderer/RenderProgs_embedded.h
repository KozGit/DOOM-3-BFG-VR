...
static const cgShaderDef_t cg_renderprogs[] =
{
	...
	{
		"renderprogs/oculusWarpChrAb.pixel",
		"/*\n"
		"===========================================================================\n"
		"\n"
		"Doom 3 BFG Edition GPL Source Code\n"
		...
		"void main( PS_IN fragment, out PS_OUT result ) {\n"
		"\n"
		"	float ResultR = tex2Dlod( samp0, fragment.texcoord0).r;\n"
		"	float ResultG = tex2Dlod( samp0, fragment.texcoord1).g;\n"
		"	float ResultB = tex2Dlod( samp0, fragment.texcoord2).b;\n"
		"\n"
		"	float4 outColor = float4( ResultR * fragment.color.r, ResultG * fragment.color.g, ResultB * fragment.color.b, 1.0 );\n"
		"\n"
		"	if ( rpOverdriveScales.x > 0.0 )\n"
		"	{\n"
		"		float2 frag = fragment.position.xy * 0.5 + 0.5;\n"
	...
	{
		"renderprogs/oculusWarpChrAb.vertex",
		"/*\n"
		"===========================================================================\n"
		"\n"
		"Doom 3 BFG Edition GPL Source Code\n"
