...
keyname_t keynames[] =
{
	...
	NAMEKEY( JOY17, "L_HYDRA1" ),
	NAMEKEY( JOY18, "L_HYDRA2" ),
	NAMEKEY( JOY19, "L_HYDRA3" ),
	NAMEKEY( JOY20, "L_HYDRA4" ),
	NAMEKEY( JOY21, "L_HYDRASTART" ),
	NAMEKEY( JOY22, "L_HYDRABUMP" ),
	NAMEKEY( JOY23, "L_HYDRASTICK" ),
	NAMEKEY( JOY24, "R_HYDRA1" ),
	NAMEKEY( JOY25, "R_HYDRA2" ),
	NAMEKEY( JOY26, "R_HYDRA3" ),
	NAMEKEY( JOY27, "R_HYDRA4" ),
	...
	NAMEKEY( HYDRA_LEFT_STICK_LEFT, "L_HYDRA_L" ),
	NAMEKEY( HYDRA_LEFT_STICK_RIGHT, "L_HYDRA_R" ),

	NAMEKEY( HYDRA_RIGHT_STICK_UP, "R_HYDRA_U" ),
	NAMEKEY( HYDRA_RIGHT_STICK_DOWN, "R_HYDRA_D" ),
	NAMEKEY( HYDRA_RIGHT_STICK_LEFT, "R_HYDRA_L" ),
	NAMEKEY( HYDRA_RIGHT_STICK_RIGHT, "R_HYDRA_R" ),
