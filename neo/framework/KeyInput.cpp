...
keyname_t keynames[] =
{
	...
	NAMEKEY( JOY20, "L_TOUCHSTICK" ),
	NAMEKEY( JOY21, "L_TOUCHPAD" ),
	NAMEKEY( JOY22, "L_TOUCHGRIP" ),
	NAMEKEY( JOY23, "L_TOUCHTRIG" ),
	NAMEKEY( JOY24, "R_TOUCHA" ),
	NAMEKEY( JOY25, "R_TOUCHB" ),
	NAMEKEY( JOY26, "R_TOUCHM" ),
	NAMEKEY( JOY27, "R_TOUCHSTICK" ),
	...
	NAMEKEY( JOY33, "L_STEAMVR_GRIP" ),
	NAMEKEY( JOY34, "L_STEAMVR_DPADL" ),
	NAMEKEY( JOY35, "L_STEAMVR_DPADU" ),
	NAMEKEY( JOY36, "L_STEAMVR_DPADR" ),
	NAMEKEY( JOY37, "L_STEAMVR_DPADD" ),
	NAMEKEY( JOY38, "L_STEAMVR_A" ),
	NAMEKEY( JOY39, "L_STEAMVR_PAD" ),
	NAMEKEY( JOY40, "L_STEAMVR_TRIG" ),
	NAMEKEY( JOY41, "L_STEAMVR_8" ),
	NAMEKEY( JOY42, "L_STEAMVR_9" ),
	NAMEKEY( JOY43, "L_STEAMVR_10" ),
	NAMEKEY( JOY44, "L_STEAMVR_11" ),
	NAMEKEY( JOY45, "L_STEAMVR_12" ),
	NAMEKEY( JOY46, "L_STEAMVR_13" ),
	NAMEKEY( JOY47, "L_STEAMVR_14" ),
	NAMEKEY( JOY48, "L_STEAMVR_15" ),


	NAMEKEY( JOY49, "R_STEAMVR_SYS" ),
	NAMEKEY( JOY50, "R_STEAMVR_APP" ),
	NAMEKEY( JOY51, "R_STEAMVR_GRIP" ),
	NAMEKEY( JOY52, "R_STEAMVR_DPADL" ),
	NAMEKEY( JOY53, "R_STEAMVR_DPADU" ),
	NAMEKEY( JOY54, "R_STEAMVR_DPADR" ),
	NAMEKEY( JOY55, "R_STEAMVR_DPADD" ),
	NAMEKEY( JOY56, "R_STEAMVR_A" ),
	NAMEKEY( JOY57, "R_STEAMVR_PAD" ),
	NAMEKEY( JOY58, "R_STEAMVR_TRIG" ),
	NAMEKEY( JOY59, "R_STEAMVR_8" ),
	NAMEKEY( JOY60, "R_STEAMVR_9" ),
	NAMEKEY( JOY61, "R_STEAMVR_10" ),
	NAMEKEY( JOY62, "R_STEAMVR_11" ),
	NAMEKEY( JOY63, "R_STEAMVR_12" ),
	NAMEKEY( JOY64, "R_STEAMVR_13" ),
	NAMEKEY( JOY65, "R_STEAMVR_14" ),
	NAMEKEY( JOY66, "R_STEAMVR_15" ),
	...
	NAMEKEY2( SAY_PDA ),
	NAMEKEY2( SAY_FIST ),
	NAMEKEY2( SAY_CHAINSAW ),
	NAMEKEY2( SAY_FLASHLIGHT ),
	NAMEKEY2( SAY_GRABBER ),
	NAMEKEY2( SAY_PISTOL ),
	NAMEKEY2( SAY_SHOTGUN ),
	NAMEKEY2( SAY_SUPER_SHOTGUN ),
	NAMEKEY2( SAY_MACHINE_GUN ),
	NAMEKEY2( SAY_CHAIN_GUN ),
	NAMEKEY2( SAY_ROCKET_LAUNCHER ),
	NAMEKEY2( SAY_GRENADES ),
	NAMEKEY2( SAY_PLASMA_GUN ),
	NAMEKEY2( SAY_BFG ),
	NAMEKEY2( SAY_SOUL_CUBE ),
	NAMEKEY2( SAY_ARTIFACT ),
	NAMEKEY2( SAY_RESET_VIEW ),

	NAMEKEY( TOUCH_LEFT_STICK_UP, "L_TOUCH_U" ),
	NAMEKEY( TOUCH_LEFT_STICK_DOWN, "L_TOUCH_D" ),
	NAMEKEY( TOUCH_LEFT_STICK_LEFT, "L_TOUCH_L" ),
	NAMEKEY( TOUCH_LEFT_STICK_RIGHT, "L_TOUCH_R" ),

	NAMEKEY( TOUCH_RIGHT_STICK_UP, "R_TOUCH_U" ),
	NAMEKEY( TOUCH_RIGHT_STICK_DOWN, "R_TOUCH_D" ),
	NAMEKEY( TOUCH_RIGHT_STICK_LEFT, "R_TOUCH_L" ),
	NAMEKEY( TOUCH_RIGHT_STICK_RIGHT, "R_TOUCH_R" ),
