...
enum joystickAxis_t
{
	...
	// Koz begin hydra joystic axissessessssssss
	AXIS_LEFT_HYDRA_X,
	AXIS_LEFT_HYDRA_Y,
	AXIS_RIGHT_HYDRA_X,
	AXIS_RIGHT_HYDRA_Y,
	AXIS_LEFT_HYDRA_TRIG,
	AXIS_RIGHT_HYDRA_TRIG,
...
enum sys_jEvents
{
	...
	J_ACTION29,
	J_ACTION30,
	J_ACTION31, // openvr controller button start ( app, grip, trig, pad )
	J_ACTION32,
	J_ACTION33, 
	J_ACTION34,
	J_ACTION35,
	...
	// Koz begin hydra
	J_AXIS_LEFT_HYDRA_X = J_AXIS_MIN + AXIS_LEFT_HYDRA_X,
	J_AXIS_LEFT_HYDRA_Y = J_AXIS_MIN + AXIS_LEFT_HYDRA_Y,
	J_AXIS_RIGHT_HYDRA_X = J_AXIS_MIN + AXIS_RIGHT_HYDRA_X,
	J_AXIS_RIGHT_HYDRA_Y = J_AXIS_MIN + AXIS_RIGHT_HYDRA_Y,
	J_AXIS_LEFT_HYDRA_TRIG = J_AXIS_MIN + AXIS_LEFT_HYDRA_TRIG,
	J_AXIS_RIGHT_HYDRA_TRIG = J_AXIS_MIN + AXIS_RIGHT_HYDRA_TRIG,
...
enum keyNum_t
{
	...
	K_JOY29,
	K_JOY30,
	K_JOY31, // openVR controller buttons
	K_JOY32,
	K_JOY33,
	K_JOY34,
	K_JOY35,
	...
	// Koz begin hydra sticks
	K_HYDRA_LEFT_STICK_UP,  //KOZ HYDRA
	K_HYDRA_LEFT_STICK_DOWN,
	K_HYDRA_LEFT_STICK_LEFT,
	K_HYDRA_LEFT_STICK_RIGHT,

	K_HYDRA_RIGHT_STICK_UP,
	K_HYDRA_RIGHT_STICK_DOWN,
	K_HYDRA_RIGHT_STICK_LEFT,
	K_HYDRA_RIGHT_STICK_RIGHT,
