This file documents the use of a joystick/gamepad under Linux with Doom3-BFG-VR.
...
No matter how many joysticks you have, Doom3-BFG-VR only uses the first 
joystick named /dev/input/js0.

b) Make sure Doom3-BFG-VR detects and is able to use your joystick.

Execute Doom3-BFG-VR in a console/terminal to see the messages printed there. If
...
in sleeping mode when you run Doom3-BFG-VR) and that you have permissions
...
available so you can map more actions. Also note that Doom3-BFG-VR treats 
