...
Section "Base" SEC01
  ...
  File "${BUILD_DIR}\avcodec-58.dll"
  File "${BUILD_DIR}\avdevice-58.dll"
  File "${BUILD_DIR}\avfilter-7.dll"
  File "${BUILD_DIR}\avformat-58.dll"
  File "${BUILD_DIR}\avutil-56.dll"
  File "${BUILD_DIR}\postproc-55.dll"
  File "${BUILD_DIR}\swresample-3.dll"
  File "${BUILD_DIR}\swscale-5.dll"
